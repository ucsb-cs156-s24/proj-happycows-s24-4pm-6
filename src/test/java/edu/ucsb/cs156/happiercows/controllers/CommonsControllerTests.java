...
public class CommonsControllerTests extends ControllerTestCase {
        ...
        public void getDefaultCommonsValuesTest() throws Exception {
                ...
                assertEquals(expectedDefaults.get("aboveCapacityHealthUpdateStrategy"),
                                actualDefaults.get("aboveCapacityHealthUpdateStrategy"));
                assertEquals(expectedDefaults.get("belowCapacityHealthUpdateStrategy"),
                                actualDefaults.get("belowCapacityHealthUpdateStrategy"));
        }
        ...
        public void getCommonsTest() throws Exception {
                ...
                List<Commons> actualCommons = objectMapper.readValue(responseString,
                                new TypeReference<List<Commons>>() {
                                });
        ...
        public void getHealthUpdateStrategiesTest() throws Exception {
                var response = mockMvc.perform(
                                get("/api/commons/all-health-update-strategies")).andExpect(status().isOk())
                                .andReturn();

                var expected = HealthUpdateStrategyList.create();
                var actual = mapper.readValue(response.getResponse().getContentAsString(),
                                HealthUpdateStrategyList.class);
        ...
        public void deleteCommons_test_admin_nonexists() throws Exception {
                ...
                Map<String, Object> expectedJson = mapper.readValue(expectedString,
                                new TypeReference<Map<String, Object>>() {
                                });
        ...
        public void getCommonsPlusTest() throws Exception {
                ...
                when(commonsPlusBuilderService.convertToCommonsPlus(eq(expectedCommons)))
                                .thenReturn(expectedCommonsPlus);
        ...
        @WithMockUser(roles = { "USER" })
        @Test
        void test_capacity_with_lower_per_user() throws Exception {
        ...
        @WithMockUser(roles = { "USER" })
        @Test
        void test_capacity_with_higher_per_user() throws Exception {
