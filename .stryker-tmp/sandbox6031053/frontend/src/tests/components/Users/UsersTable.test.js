...
describe("UserTable tests", () => {
    ...
    test("has Edit Commons header and id", () => {
        render(<UsersTable users={usersFixtures.threeUsers} />);
        //const editCommonsHeader = screen.getByText("Edit Commons");
        //expect(editCommonsHeader).toBeInTheDocument();
    
        const editCommonsButtons = screen.getAllByTestId(/edit-commons-/);
        expect(editCommonsButtons.length).toBe(usersFixtures.threeUsers.length);
    });
